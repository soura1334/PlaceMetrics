...
export default function LeftHero() {
  return (
    <div className="flex flex-col py-4">
      {/* Top Section */}
      <div className="p-4 border rounded-4xl bg-black/40 text-teal-400 backdrop-blur-md border-teal-400/40 w-fit flex items-center gap-2">
        <Activity size={15} />
      ...
      <div className="lg:text-sm text-xs flex gap-6 mt-8">
        ...
        <button className="border-2 border-teal-400/40 rounded-lg text-teal-400 bg-black/40 p-2 lg:px-4 ">
          View Demo
        </button>
      </div>
      {/* Text */}
